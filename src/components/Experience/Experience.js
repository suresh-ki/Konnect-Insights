        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-y-16 gap-5 mt-10 lg:mt-14 pt-10">
          <div className="bg-[#FDF7F2] rounded-3xl ">
            ...
            <div className="pt-2.5 pb-6 px-5 flex flex-col gap-2">
              <div className="font-medium lg:text-lg rounded-lg border-[#FFE5DD] border-2 bg-white text-center py-3 flex items-center justify-center px-2.5">
                Social Media
              </div>
              <div className="font-medium lg:text-lg rounded-lg border-[#FFE5DD] border-2 bg-white text-center py-3 flex items-center justify-center px-2.5">
                Online Web
          ...
          <div className="bg-[#FFFDEB] rounded-3xl flex flex-col">
            ...
            <div className="pt-2.5 pb-6 px-5 flex flex-col gap-2 flex-1">
              <div className="font-medium lg:text-lg rounded-lg border-[#FFEAC0] border-2 bg-white text-center py-3 flex-1 flex items-center justify-center px-2.5">
                Calling
              </div>
              <div className="font-medium lg:text-lg rounded-lg border-[#FFEAC0] border-2 bg-white text-center py-3 flex-1 flex items-center justify-center px-2.5">
                Chats
          ...
          <div className="bg-[#E1FDF2] rounded-3xl flex flex-col">
            ...
            <div className="pt-2.5 pb-6 px-5 flex flex-col gap-2 flex-1">
              <div className="font-medium lg:text-lg rounded-lg border-[#C3FFEA] border-2 bg-white text-center py-3 flex-1 flex items-center justify-center px-2.5">
                Analytics
              </div>
              <div className="font-medium lg:text-lg rounded-lg border-[#C3FFEA] border-2 bg-white text-center py-3 flex-1 flex items-center justify-center px-2.5">
                CRM
          ...
          <div className="bg-[#E8F4FC] rounded-3xl flex flex-col">
            ...
            <div className="pt-2.5 pb-6 px-5 flex flex-col gap-2 flex-1">
              <div className="font-medium lg:text-lg rounded-lg border-[#5BBCF5] border-2 bg-white text-center py-3 flex-1 flex items-center justify-center px-2.5">
                Publishing
              </div>
              <div className="font-medium lg:text-lg rounded-lg border-[#5BBCF5] border-2 bg-white text-center py-3 flex-1 flex items-center justify-center px-2.5">
