...
const Tabs = () => {
  ...
  const data = [
    {
      ...
      content: [
        {
          title: "Listen to the online web, Social Media and a lot more",
          parah:
            "Do not miss out on any conversation anywhere on the web. Listen to your customer's voices, engage with them and make them happier.",
        },
        {
        ...
        },
        {
          ...
          parah:
            "Understand sentiment, share of voice, media type, classification, influence, demographics, and campaign insights. With great dashboards and smart suggestion (KISS) reports.",
        },
        {
...

    {
      ...
      content: [
        ...
        },
        {
          ...
          parah:
            "With all your insights in one platform, identify trends, pain points, hits and misses, moments when your audience is active, and much more to shape and align messaging into consumer-relevant and engagement-driven quickly.",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          parah:
            "Pre-save all your content, including text and media, into the creative asset library. Easily pick them up for publishing and scheduling, giving your design and content teams the flexibility to plan and execute your campaigns and festivals.",
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          parah:
            "Create dashboards for various stakeholders by simply dragging and dropping charts from the chart library or charts created using BI tools. Bring in your external data sources to create dashboards.",
        },
        {
          title: "Create your own charts",
          parah:
            "Create any type of chart using advanced features such as pivoting, define your filters, columns, dimensions, and measures, which are completely tailored to your needs while going granular, equipping you with intelligent insights for better business decisions.",
        },
        {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="container max-w-[1200px] pt-16 lg:pt-20">
